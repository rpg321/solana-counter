	...
	async function getUserCount(){
		if(countProgram && publicKey){
			try{
				...
				if(found.account.theCount !== undefined){
	...
	<div className="flex items-center justify-center w-full h-screen relative z-10">
		<div className="wrapper text-center">
			...
			<button
				disabled={!publicKey}
				onClick={storeCount}
				className="rounded-full h-16 w-36 block mt-4 mx-auto bg-green-500 text-white text-lg mx-2 hover:bg-green-600 transition-colors duration-200 disabled:hover:bg-green-500 disabled:opacity-50 disabled:cursor-not-allowed"
			>
				Save Count
			</button>
